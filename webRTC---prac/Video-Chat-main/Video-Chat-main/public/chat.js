...
socket.on("created", function () {
  ...
  navigator.mediaDevices
    ...
    .then(function (stream) {
      ...
      // Mute the audio track for local stream
...
socket.on("ready", function () {
  if (creator) {
    ...
    rtcPeerConnection.addTrack(userStream.getTracks()[0], userStream); // Adding audio track
    rtcPeerConnection.addTrack(userStream.getTracks()[1], userStream); // Adding video track
